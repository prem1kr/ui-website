  ...
  const services = [
    {
      ...
      icon: "/path-to-job-matching-icon.png", // Replace with the correct path for the image
    },
    {
      ...
      icon: "/path-to-resume-building-icon.png",
    },
    {
      ...
      icon: "/path-to-candidate-sourcing-icon.png",
    },
    {
      ...
      icon: "/path-to-recruitment-support-icon.png",
    },
  ];
    ...
    >
      ...
      <Grid container spacing={4} justifyContent="center" alignItems="center">
        ...
        <Grid item xs={12} md={4} textAlign="center">
          <img
            src="/path-to-central-image.png" // Replace with the correct image path
